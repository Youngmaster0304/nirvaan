...
add_textbox(slide1, Inches(1), Inches(1.8), Inches(11), Inches(1.2),
            "RailBlock AI", font_size=54, bold=True, color=PRIMARY, alignment=PP_ALIGN.CENTER)
...
add_textbox(slide2, Inches(0.5), Inches(0.9), Inches(12), Inches(0.5),
            "Proposed Solution: RailBlock AI - Intelligent Block Planning System",
...
add_textbox(slide6, Inches(0.5), Inches(6.5), Inches(12), Inches(0.5),
            "Thank You | RailBlock AI | Team [Your Team Name]",
            font_size=16, bold=True, color=PRIMARY, alignment=PP_ALIGN.CENTER)

# Save
output_path = r'C:\Users\Abhinav\sih-railways\presentation\SIH26027_RailBlockAI_Presentation.pptx'
